...
# Enhanced with unified cross-document search capability
...
app = FastAPI(title="Document-Centric RAG API", description="RAG API with unified and individual document search")
...
if __name__ == "__main__":
    print("🚀 Starting Enhanced RAG API Server with Unified Search...")
    ...
    print(f"🔍 Search Modes: Unified, Individual, Hybrid")
    print("="*50)
